...
> **Important**: set the `OIDC_TOKEN_ROLE_PATH` variable properly to match the created client. For example, if your client names `client_with_another_name`, you should set `OIDC_TOKEN_ROLE_PATH=&.client_with_another_name.roles`.
